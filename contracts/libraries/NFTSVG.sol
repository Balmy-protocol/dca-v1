  ...
  function _generageSVGProgressArea(uint32 _swapsExecuted, uint32 _swapsLeft) private pure returns (string memory svg) {
    ...
    svg = string(
      abi.encodePacked(
        ...
        '<g mask="url(#none)" style="transform:translate(80px,169px)">',
        '<rect x="-16px" y="-16px" width="180px" height="180px" fill="none" />',
        '<path d="M1 1 L1 145" stroke="rgba(0,0,0,0.3)" stroke-width="32px" fill="none" stroke-linecap="round" />',
        '</g>',
        '<g mask="url(#none)" style="transform:translate(80px,169px)">',
        '<rect x="-16px" y="-16px" width="180px" height="180px" fill="none" />',
        '<path d="M1 1 L1 145" stroke="rgba(255,255,255,1)" fill="none" stroke-linecap="round" />',
        '</g>',
        '<circle cx="81px" cy="170px" r="4px" fill="#dddddd" />',
        '<circle cx="81px" cy="',
        _positionNow.toString(),
        'px" r="5px" fill="white" />',
        '<circle cx="81px" cy="314px" r="4px" fill="#dddddd" />',
        '<text x="100px" y="174px" font-family="\'Courier New\', monospace" font-size="12px" fill="white">',
        '<tspan fill="rgba(255,255,255,0.6)">Executed*: </tspan>',
        _swapsExecuted.toString(),
        'swaps',
        '</text>',
        '<text x="40px" y="',
        (_positionNow + 4).toString(),
        'px" font-family="\'Courier New\', monospace" font-size="12px" fill="white">',
        'Now',
        '</text>',
        '<text x="100px" y="318px" font-family="\'Courier New\', monospace" font-size="12px" fill="white">',
        '<tspan fill="rgba(255,255,255,0.6)">Left: </tspan>',
        _swapsLeft.toString(),
        'swaps',
        '</text>'
      )
